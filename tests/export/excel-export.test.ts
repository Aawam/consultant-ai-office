...
const rab = (status: RabVersion["status"]): RabVersion => ({ rabVersionId: "rab-1", projectId: project.projectId, revisionOfRabVersionId: null, revisionNumber: 1, title: "Test RAB", status, ohProfitRate: "0.10", ppnRate: "0.11", items: [], validation: null, calculationSnapshot: status === "DRAFT" ? null : { calculatedAt: project.createdAt, itemValues: {}, totals: { subtotalRab: "0", ppnValue: "0", totalBeforeRounding: "0", totalFinal: "0", roundingDifference: "0" } }, confirmedWarningCodes: [], createdBy: "tester", createdAt: project.createdAt, updatedAt: project.createdAt });
...
function dependencies(status: RabVersion["status"]) {
  const record = { artifactId: "artifact-1", projectId: project.projectId, rabVersionId: "rab-1", exportType: "OFFICIAL" as const, status, generatedBy: "admin", generatedAt: project.createdAt, filePath: "", sha256: "" };
